...
<div class="container text-center">
	<s:action name="test" executeResult="true" />
		<ul class="breadcrumb">
			<li>Home</li>
	  		<li>Exam Seller Report</li>
		</ul>
		<div class="jumbotron">
		<div class="col-sm-12" >Item details of seller=<s:property value="sellername"/></div>
		</div>
		<div class="jumbotron">
		...
		<div class="col-sm-1"><s:property value="index"/></div>		
		<div class="col-sm-2" ><s:property value="itemId"/></div>
		<div class="col-sm-3" ><s:property value="itemname"/></div>
		<div class="col-sm-3" ><s:property value="weight"/></div>
